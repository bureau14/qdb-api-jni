...
public final class qdb
{
    static
    {
        ...
        else if (os.startsWith("Mac OS X"))
        {
            ...
            {
                NativeLibraryLoader.load("/net/quasardb/qdb/jni/osx/aarch64/libqdb_api.dylib");
                NativeLibraryLoader.load("/net/quasardb/qdb/jni/osx/aarch64/libqdb_api_jni.dylib");
            }
            else
            {
    ...
    public static native int option_set_client_max_batch_load(long handle, long batchLoad);
    public static native long option_get_client_max_batch_load(long handle);
