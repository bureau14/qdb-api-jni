...
class string
{
  public:
     ...
     */
    static jni::guard::string_utf8 get_chars_utf8(qdb::jni::env &env,
                                                  jstring str);
     ...
     */
    static jni::guard::string_critical get_chars_critical(qdb::jni::env &env,
                                                          jstring str);
    ...
    static jni::guard::local_ref<jstring> create_utf8(jni::env &env,
                                                      char const *str);

    static jni::guard::local_ref<jstring>
    create_utf8(jni::env &env, char const *str, qdb_size_t contentLength);

    /**
     * Create new array of Strings with certain size.
     */
    static jni::guard::local_ref<jobjectArray> create_array(jni::env &env,
                                                            jsize size);
    ...
    {
        return jni::introspect::lookup_field(env, objectClass, alias,
                                             "Ljava/lang/String;");
    }
};
}; // namespace jni
