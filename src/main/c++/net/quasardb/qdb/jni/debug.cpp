...
/* static */ std::string qdb::jni::debug::hexdump(void const * buf_, size_t len)
{
...
/* static */ void qdb::jni::debug::println(env & env, std::string const & msg)
{
    qdb::jni::debug::println(env, msg.c_str());
}

/* static */ void qdb::jni::debug::println(env & env, char const * msg)
{
    jclass syscls = introspect::lookup_class(env, "java/lang/System");

    // Lookup the "out" field
    jfieldID fid = introspect::lookup_static_field(env, syscls, "out", "Ljava/io/PrintStream;");
    ...
    jmethodID mid = introspect::lookup_method(env, pscls, "println", "(Ljava/lang/String;)V");
