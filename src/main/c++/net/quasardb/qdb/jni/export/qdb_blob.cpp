    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_compare_and_swap((qdb_handle_t)handle,
                qdb::jni::string::get_chars_utf8(env, alias), newContentPtr, newContentSize,
                comparandPtr, comparandSize, expiry, &originalContentPtr, &originalContentSize));
    ...
    JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jstring alias, jobject content)
{
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_get((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_get_and_remove((qdb_handle_t)handle,
                qdb::jni::string::get_chars_utf8(env, alias), &contentPtr, &contentSize));
        setByteBuffer(env, content, contentPtr, contentSize);
        return qdb_e_ok;
    }
    catch (jni::exception const & e)
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_get_and_update((qdb_handle_t)handle,
                qdb::jni::string::get_chars_utf8(env, alias), newContentPtr, newContentSize, expiry,
    ...
    jlong expiry)
{
    ...
    try
    {
        ...
        return jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_put((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
    ...
    JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jstring alias, jobject comparand)
{
    ...
    try
    {
        ...
        qdb_size_t comparandSize  = (qdb_size_t)env.instance().GetDirectBufferCapacity(comparand);
        return jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_remove_if((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
    ...
    jlong expiry)
{
    ...
    try
    {
        ...
        qdb_size_t contentSize  = (qdb_size_t)env.instance().GetDirectBufferCapacity(content);
        return jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_blob_update((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
                contentPtr, contentSize, expiry));
    }
    catch (jni::exception const & e)
    {
