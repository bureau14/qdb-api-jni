...
extern "C" JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_delete_1batch(JNIEnv * jniEnv, jclass /*thisClass*/,
...
extern "C" JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_run_1batch(JNIEnv * jniEnv, jclass /*thisClass*/,
                                         jlong handle, jlong batch,
                                         jint count) {
...
extern "C" JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_batch_1read_1blob_1get_1and_1update(JNIEnv * jniEnv,
                                                                  jclass /*thisClass*/,
                                                                  jlong handle,
                                                                  jlong batch,
                                                                  jint index,
