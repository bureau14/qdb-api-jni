...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1double_1insert(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    jobjectArray points)
{
    ...
    try
    {
        ...
        qdb_ts_double_point * values =
            (qdb_ts_double_point *)(malloc(points_count * sizeof(qdb_ts_double_point)));

        doublePointsToNative(env, points, points_count, values);

        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_ts_double_insert((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
                qdb::jni::string::get_chars_utf8(env, column), values, points_count));
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1double_1get_1ranges(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_ts_double_get_ranges((qdb_handle_t)handle,
                ...
                qdb::jni::string::get_chars_utf8(env, column), native_ranges.data(),
                native_ranges.size(), &native_points, &point_count));

        setReferenceValue(
            env, points, nativeToDoublePoints(env, native_points, point_count).release());
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1double_1aggregate(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_ts_double_aggregate((qdb_handle_t)handle,
                qdb::jni::string::get_chars_utf8(env, alias),
                qdb::jni::string::get_chars_utf8(env, column), aggregates, count));

        setReferenceValue(env, output, nativeToDoubleAggregates(env, aggregates, count).release());
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1blob_1insert(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    jobjectArray points)
{
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_ts_blob_insert((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias),
                qdb::jni::string::get_chars_utf8(env, column), values, pointsCount));
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1blob_1get_1ranges(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    ...
    try
    {
        ...
        jni::exception::throw_if_error((qdb_handle_t)handle,
            qdb_ts_blob_get_ranges((qdb_handle_t)handle,
                qdb::jni::string::get_chars_utf8(env, alias),
                qdb::jni::string::get_chars_utf8(env, column), native_ranges.data(),
                native_ranges.size(), &nativePoints, &pointCount));
        ...
        setReferenceValue(env, points, nativeToBlobPoints(env, nativePoints, pointCount).release());
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1string_1get_1ranges(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    ...
    jobject points)
{
    ...
    try
    {
        ...
        // garbage collector. As such, we do NOT call `qdb_release` here
        setReferenceValue(
            env, points, nativeToStringPoints(env, nativePoints, pointCount).release());
...
JNIEXPORT jint JNICALL Java_net_quasardb_qdb_jni_qdb_ts_1blob_1aggregate(JNIEnv * jniEnv,
    jclass /*thisClass*/,
    jlong handle,
    jstring alias,
    jstring column,
    ...
    jobject output)
{
    ...
    try
    {
        ...
        setReferenceValue(env, output, nativeToBlobAggregates(env, aggregates, count).release());
