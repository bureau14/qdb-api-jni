...
Java_net_quasardb_qdb_jni_qdb_int_1put(JNIEnv *jniEnv,
                                       jclass /*thisClass*/,
                                       jlong handle,
                                       jstring alias,
                                       jlong value,
    ...
    try
    {
        return jni::exception::throw_if_error(
            ...
            qdb_int_put((qdb_handle_t)handle,
                        qdb::jni::string::get_chars_utf8(env, alias), value,
                        expiry));
    }
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_int_1update(JNIEnv *jniEnv,
                                          jclass /*thisClass*/,
                                          jlong handle,
                                          jstring alias,
                                          jlong value,
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_int_1get(JNIEnv *jniEnv,
                                       jclass /*thisClass*/,
                                       jlong handle,
                                       jstring alias,
                                       jobject value)
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_int_1add(JNIEnv *jniEnv,
                                       jclass /*thisClass*/,
                                       jlong handle,
                                       jstring alias,
                                       jlong addend,
    ...
    try
    {
        ...
        jni::exception::throw_if_error(
            ...
            qdb_int_add((qdb_handle_t)handle,
                        qdb::jni::string::get_chars_utf8(env, alias), addend,
                        &nativeResult));
