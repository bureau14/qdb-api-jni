...
Java_net_quasardb_qdb_jni_qdb_attach_1tag(JNIEnv *jniEnv,
                                          jclass /*thisClass*/,
                                          jlong handle,
                                          jstring alias,
                                          jstring tag)
{
    ...
    try
    {
        return jni::exception::throw_if_error(
            (qdb_handle_t)handle,
            qdb_attach_tag((qdb_handle_t)handle,
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_has_1tag(JNIEnv *jniEnv,
                                       jclass /*thisClass*/,
                                       jlong handle,
                                       jstring alias,
                                       jstring tag)
{
    ...
    try
    {
        return jni::exception::throw_if_error(
            (qdb_handle_t)handle,
            qdb_has_tag((qdb_handle_t)handle,
                        qdb::jni::string::get_chars_utf8(env, alias),
                        qdb::jni::string::get_chars_utf8(env, tag)));
    }
    catch (jni::exception const &e)
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_detach_1tag(JNIEnv *jniEnv,
                                          jclass /*thisClass*/,
                                          jlong handle,
                                          jstring alias,
                                          jstring tag)
{
    ...
    try
    {
        return jni::exception::throw_if_error(
            (qdb_handle_t)handle,
            qdb_detach_tag((qdb_handle_t)handle,
                           qdb::jni::string::get_chars_utf8(env, alias),
                           qdb::jni::string::get_chars_utf8(env, tag)));
    }
    catch (jni::exception const &e)
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_get_1tags(JNIEnv *jniEnv,
                                        jclass /*thisClass*/,
                                        jlong handle,
                                        jstring alias,
                                        jobject tags)
{
    ...
    try
    {
        ...
        jni::exception::throw_if_error(
            (qdb_handle_t)handle,
            qdb_get_tags((qdb_handle_t)handle,
                         qdb::jni::string::get_chars_utf8(env, alias),
                         &nativeTags, &tagCount));
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1begin(JNIEnv *jniEnv,
                                                   jclass /*thisClass*/,
                                                   jlong handle,
                                                   jstring alias,
                                                   jobject iterator)
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1next(JNIEnv *jniEnv,
                                                  jclass /*thisClass*/,
                                                  jlong iterator)
{
    qdb::jni::env env(jniEnv);
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1close(JNIEnv *jniEnv,
                                                   jclass /*thisClass*/,
                                                   jlong iterator)
{
    qdb::jni::env env(jniEnv);
...
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1alias(JNIEnv *jniEnv,
                                                   jclass /*thisClass*/,
                                                   jlong iterator)
{
    qdb::jni::env env(jniEnv);
    ...
    try
    {
        if (iterator)
        {
            return env.instance().NewStringUTF(
                ((qdb_const_tag_iterator_t *)iterator)->alias);
        }
        else
        {
            return NULL;
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1type(JNIEnv *jniEnv,
                                                  jclass /*thisClass*/,
                                                  jlong iterator)
{
    qdb::jni::env env(jniEnv);
