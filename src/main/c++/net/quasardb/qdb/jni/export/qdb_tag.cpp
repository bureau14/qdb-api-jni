...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1next(JNIEnv * jniEnv, jclass /*thisClass*/, jlong iterator) {
  qdb::jni::env env(jniEnv);
  try {
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1close(JNIEnv * jniEnv, jclass /*thisClass*/, jlong iterator) {
  qdb::jni::env env(jniEnv);
  try {
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1type(JNIEnv * jniEnv, jclass /*thisClass*/, jlong iterator) {
  qdb::jni::env env(jniEnv);
