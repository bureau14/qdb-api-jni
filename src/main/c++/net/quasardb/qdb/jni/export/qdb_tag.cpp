...
Java_net_quasardb_qdb_jni_qdb_attach_1tag(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
  ...
  return qdb_attach_tag((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), qdb::jni::string::get_chars_utf8(env, tag));
}
...
Java_net_quasardb_qdb_jni_qdb_has_1tag(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jstring alias,
  ...
  return qdb_has_tag((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), qdb::jni::string::get_chars_utf8(env, tag));
}
...
Java_net_quasardb_qdb_jni_qdb_detach_1tag(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
  ...
  return qdb_detach_tag((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), qdb::jni::string::get_chars_utf8(env, tag));
}
...
Java_net_quasardb_qdb_jni_qdb_get_1tags(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jstring alias,
  ...
  size_t tagCount = 0;
  qdb_error_t err =
      qdb_get_tags((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), &nativeTags, &tagCount);
...
Java_net_quasardb_qdb_jni_qdb_tag_1iterator_1begin(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
  ...
  qdb_error_t err =
      qdb_tag_iterator_begin((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), nativeIterator);
  if (QDB_SUCCESS(err)) {
