...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_close(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle) {
  qdb::jni::env env(jniEnv);
  try {
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_option_1set_1timeout(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
                                                   jint timeout) {
  qdb::jni::env env(jniEnv);
  try {
    return jni::exception::throw_if_error((qdb_handle_t)handle,
...
JNIEXPORT jlong JNICALL
Java_net_quasardb_qdb_jni_qdb_option_1get_1client_1max_1in_1buf_1size(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle) {
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_option_1set_1client_1max_1in_1buf_1size(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jlong size) {

  qdb::jni::env env(jniEnv);
  try {
    return jni::exception::throw_if_error((qdb_handle_t)handle,
                                          qdb_option_set_client_max_in_buf_size((qdb_handle_t)handle,
                                                                                size));
  } catch (jni::exception const & e) {
    e.throw_new(env);
    return e.error();
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_purge_1all(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
                                         jint timeout) {
  qdb::jni::env env(jniEnv);
  try {
    return jni::exception::throw_if_error((qdb_handle_t)handle,
                                          qdb_purge_all((qdb_handle_t)handle, timeout));
  } catch (jni::exception const & e) {
    e.throw_new(env);
    return e.error();
  }
...
JNIEXPORT jint JNICALL
Java_net_quasardb_qdb_jni_qdb_trim_1all(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle, jint timeout) {
  qdb::jni::env env(jniEnv);
  try {
    return jni::exception::throw_if_error((qdb_handle_t)handle,
                                          qdb_trim_all((qdb_handle_t)handle, timeout));
  } catch (jni::exception const & e) {
    e.throw_new(env);
    return e.error();
  }
...
Java_net_quasardb_qdb_jni_qdb_expires_1at(JNIEnv * jniEnv, jclass /*thisClass*/, jlong handle,
  ...
  try {
    return jni::exception::throw_if_error((qdb_handle_t)handle,
                                          qdb_expires_at((qdb_handle_t)handle, qdb::jni::string::get_chars_utf8(env, alias), expiry));
  } catch (jni::exception const & e) {
    e.throw_new(env);
    return e.error();
  }
