...
namespace qdb {
    namespace jni {
        ...
        public:
           ...
           */
          void
          throw_new(jni::env & env) const noexcept;
           ...
           */
          static qdb_error_t
          throw_if_error(qdb_handle_t h, qdb_error_t e);
           ...
           */
          static qdb_error_t
          throw_if_error(qdb_handle_t h, std::initializer_list<qdb_error_t> xs, qdb_error_t e) {

            // TODO(leon): we can probably do this entirely at compile-time, as the initializer
